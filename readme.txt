...
5. Major Fixes. New shortcodes for testimonials, before and afters and office images widgets.
6. Additional shortcode attributes on client options - multiple information and shortcode fixes for widgets.
7. Updated Flipper page and ajax.
8. Fixed custom code to accept shortcode in the footer.
...
13. Fixed after theme loads, scripts and codes.
14. Fixed gravity form loads, scripts and codes.
15. Shortcode fixes.
16. Console logs for mods are added.
17. Resmap special conditions are added.
18. Resmap mod fixes.
