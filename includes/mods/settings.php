...
function WM4D_OPTIONS_PLUGIN_register_resmap_options(){
	...
	register_setting( 'wm4d-resmap-group', 'wm4d_map_condition_select' );
	register_setting( 'wm4d-resmap-group', 'wm4d_map_condition_address' );

	register_setting( 'wm4d-resmap-group', 'wm4d_map_addresses' );
	register_setting( 'wm4d-resmap-group', 'wm4d_map_links' );
	register_setting( 'wm4d-resmap-group', 'wm4d_map_condition_addresses' );
}
...
function WM4D_OPTIONS_PLUGIN_selection_resmap() {
		if ( isset($_POST['submit']) ) {
			...
			if ( isset( $_POST['wm4d_map_condition_select'] ) )
				update_option( 'wm4d_map_condition_select', 'enable' );
			else
				update_option( 'wm4d_map_condition_select', 'false' );
