...
// Global variables
$WM4D_OPTIONS_PLUGIN_VERSION = '3.1.3';
$WM4D_OPTIONS_PLUGIN_CSS_VERSION = '3.0.7';
$WM4D_OPTIONS_PLUGIN_JS_VERSION = '3.0.8';
$WM4D_OPTIONS_PLUGIN_ADMIN_CSS_VERSION = '3.1.2';
$WM4D_OPTIONS_PLUGIN_ADMIN_JS_VERSION = '3.1.4';
$WM4D_OPTIONS_PLUGIN_ADMIN_JS2_VERSION = '1.4.2';
$WM4D_OPTIONS_PLUGIN_AJAX_ADMIN_VERSION = '1.2';
$WM4D_OPTIONS_PLUGIN_AJAX_BETA_TEST_VERSION = '1.9';
...
function load_WM4D_OPTIONS_HTML_footer_out() {
	...
	if(!empty($wm4d_footer)) echo $wm4d_footer;
}

function WM4D_OPTIONS_PLUGIN_wm4d_functions() {
	if ( get_option('wm4d_functions_select') == 'enable' ) {
		require_once(WM4D_OPTIONS_PLUGIN_DIR.'/framework/includes.php');
