...
// Global variables
$WM4D_OPTIONS_PLUGIN_VERSION = '3.2.8';
...
$WM4D_OPTIONS_PLUGIN_AJAX_MODS_VERSION = '0.0.4'; // ajax-mods
...
function WM4D_OPTIONS_PLUGIN_wm4d_functions() {
	...
	require(WM4D_OPTIONS_PLUGIN_DIR.'/framework/shortcodes-inner.php');
	require(WM4D_OPTIONS_PLUGIN_DIR.'/includes/integrations/integrations.php');
}
