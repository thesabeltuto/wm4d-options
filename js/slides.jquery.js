	...
	$.fn.slides = function( option ) {
		...
		return this.each(function(){
			...
			if (option.generateNextPrev) {
				$('.' + option.container, elem).after('<a href="#" class="'+ option.prev +'" id="slides-prev">Prev</a>');
				$('.' + option.prev, elem).after('<a href="#" class="'+ option.next +'" id="slides-next">Next</a>');
			}
